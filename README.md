...
再直白一点: 这不是普通的 AI 角色扮演，这是面试者面向信息不对称推出的**面试官逆向工程**。
...
您看，他只需要用五分钟就能了解你的名字、年纪、学历背景，工作经历，所有这一切，而你对他一无所知。当然，没有人要抱怨这一点，毕竟你的简历是到他手中而不是直接进垃圾桶了。但是，他显然也不是某个数学上的随机采样，天生就会坐在这里拷问你。他有自己的学历背景、研究方向、技术偏好，他在某个领域深耕过——而只要存在历史轨迹，就有规律可循。
...
您可以导入面试记录、公司介绍、岗位要求，以及他的背景——如果您了解的话，再加上对他的主观描述，系统将拼凑出出他——至少是他在面试这个情景空间的投影。
