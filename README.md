...
用户 ❯ 我是许文扬，中科大数院研一在读，代数几何方向，一个月前刚刚从上一家辞职，想找一份新的实习。
...
**场景二: 问题示例**
```text
interviewer.skill ❯ 有一个小岛上有100只老虎，1只羊，老虎可以吃草，但它更愿意吃羊，吃完羊之后它也会变成羊。假设这些老虎都是理性的，那么这只羊会被吃掉吗

用户 ❯ 您怎么还要问小学生的趣味数学题？

interviewer.skill ❯ 那你说答案是什么。

用户 ❯ 比如说只有一只老虎，那他肯定会吃羊的，两只老虎的话不会，因为吃完自己也变成羊，会被另一只老虎吃掉，这样类推下去，如果有奇数只老虎，那它会吃羊，偶数只则不会。
