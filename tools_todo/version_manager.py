...
def backup(base_dir: str, slug: str):
    ...
    for fname in ["techmap.md", "behavior.md", "persona.md", "SKILL.md", "meta.json"]:  # 改动1
...
def rollback(base_dir: str, slug: str, version: str):
    ...
    for fname in ["techmap.md", "behavior.md", "persona.md", "SKILL.md", "meta.json"]:  # 改动1（同步）
...
def main():
    ...
    parser.add_argument("--slug", required=True, help="面试官代号")  # 改动2
    parser.add_argument("--base-dir", default="./interviewers", help="基础目录")  # 改动3
